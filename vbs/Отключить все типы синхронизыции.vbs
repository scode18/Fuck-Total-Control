...
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\Accessibility", "Enabled", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\BrowserSettings", "Enabled", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\Credentials", "Enabled", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\Language", "Enabled", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\Personalization", "Enabled", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\SettingSync\Groups\Windows", "Enabled", "REG_DWORD", 0
