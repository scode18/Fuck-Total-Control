...
RegWrite "HKLM\SOFTWARE\Microsoft\Speech_OneCore\Preferences", "ModelDownloadAllowed", "REG_DWORD", 0
...
RegWrite "HKCU\Software\Microsoft\InputPersonalization", "RestrictImplicitInkCollection", "REG_DWORD", 1
RegWrite "HKCU\Software\Microsoft\InputPersonalization", "RestrictImplicitTextCollection", "REG_DWORD", 1
RegWrite "HKCU\Software\Microsoft\InputPersonalization\TrainedDataStore", "HarvestContacts", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Personalization\Settings", "AcceptedPrivacyPolicy", "REG_DWORD", 0
RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\Windows Search", "CortanaConsent", "REG_DWORD", 0
