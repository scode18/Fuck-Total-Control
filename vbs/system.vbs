...
RegWrite "HKLM\SYSTEM\Maps", "AutoUpdateEnabled", "REG_DWORD", 0
' ; Prefetcher, Superfetch: 2 – ускорение только загрузки системы, 3 – ускорение загрузки системы и запуска приложений
RegWrite "HKLM\SYSTEM\ControlSet001\Control\Session Manager\Memory Management\PrefetchParameters", "EnablePrefetcher", "REG_DWORD", 2
RegWrite "HKLM\SYSTEM\ControlSet001\Control\Session Manager\Memory Management\PrefetchParameters", "EnableSuperfetch", "REG_DWORD", 2
' ; Разрешить гостевой вход (для доступа к расшаренным папкам)
RegWrite "HKLM\SYSTEM\ControlSet001\Services\LanmanWorkstation\Parameters", "AllowInsecureGuestAuth", "REG_DWORD", 1
' ; Не расширять динамические VHD до максимума
RegWrite "HKLM\SYSTEM\ControlSet001\Services\FsDepends\Parameters", "VirtualDiskExpandOnMount", "REG_DWORD", 4
' ; Стандартная служба сборщика центра диагностики Microsoft
RegWrite "HKLM\SYSTEM\ControlSet001\Services\diagnosticshub.standardcollector.service", "Start", "REG_DWORD", 4
' ; Служба функциональных возможностей для подключенных пользователей и телеметрии
RegWrite "HKLM\SYSTEM\ControlSet001\Services\DiagTrack", "Start", "REG_DWORD", 4
' ; Служба помощника по совместимости программ
RegWrite "HKLM\SYSTEM\ControlSet001\Services\PcaSvc", "Start", "REG_DWORD", 4
' ; Служба демонстрации магазина
RegWrite "HKLM\SYSTEM\ControlSet001\Services\RetailDemo", "Start", "REG_DWORD", 4
' ; Служба Medic центра обновления Windows
RegWrite "HKLM\SYSTEM\ControlSet001\Services\WaaSMedicSvc", "Start", "REG_DWORD", 4
